...
namespace EDIDParser
{
    ...
    public class converter
    {
        ...
        public string[] imformation2 = new string[128];
        ...
        public converter(string strss)
        {
            ...
            {
                Array.Resize(ref imformation2,imformation16.Length);
                Array.Resize(ref imformation10, imformation16.Length);
            }
    ...
    public class EdidParser : converter
    {
        ...
        public string ChromaticityCoordinates()
        {
            ...
            gamma += "Red x :" + string.Format("{0:0.###}", Red_xy[0]) + "\n";
            gamma += "Red y :" + string.Format("{0:0.###}", Red_xy[1]) + "\n";
            gamma += "Green x :" + string.Format("{0:0.###}", Green_xy[0]) + "\n";
            gamma += "Green y :" + string.Format("{0:0.###}", Green_xy[1]) + "\n";
            gamma += "Blue x :" + string.Format("{0:0.###}", Blue_xy[0]) + "\n";
            gamma += "Blue y :" + string.Format("{0:0.###}", Blue_xy[1]) + "\n";
            gamma += "White x :" + string.Format("{0:0.###}", White_xy[0]) + "\n";
            gamma += "White y :" + string.Format("{0:0.###}", White_xy[1]) + "\n";
            return gamma;
            //////////////////////
        }
